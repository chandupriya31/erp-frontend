                ...
                <Card.Body>
                    ...
                    <Form>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control as="textarea" id="aboutus" name="aboutus" value={details.aboutus} onChange={handleDetails} />
                        </Form.Group>
                        <Form.Group className="mb-3">
                            <Form.Label>Company Mission</Form.Label>
                            <Form.Control as="textarea" id="mission" name="mission" value={details.mission} onChange={handleDetails} />
                        </Form.Group>
                        <Form.Group className="mb-3">
                            <Form.Label>Company Vision</Form.Label>
                            <Form.Control as="textarea" id="vision" name="vision" value={details.vision} onChange={handleDetails} />
                        </Form.Group>
